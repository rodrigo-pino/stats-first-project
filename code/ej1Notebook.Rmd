...
Se observa que las muestras sin remplazo de tamanno 200 y 60 tienen menor diferencia con respecto a la media y la varianza de la poblacion con respecto a las muestras de mismo tamanno y con remplazo. En este caso los valores con remplazo estuvieron mas cercano a la mediana.

Para las muestras tamanno 30 y 20 la diferencia de los estadisticos discriptivos contra la poblacion es bastate similiar a la de las muestras con remplazo. Para el caso de la muestra de tamanno 20, se obtiene mejores resultado la que se realizo con remplazo.
```{r}
