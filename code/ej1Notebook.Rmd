...
Aqui se deberian analizar las diferencias entre la media y la varianza de las muestras contra la poblacion. Sacar un error, que error se utilizaria? Error cuadratico medio? Otro error, la simple diferencia?

```{r}
#Se  hace un analisis y se ven las diferencias
```

Luego graficamos estos resultados que muestran algo imprecedente(Suena musica de suspenso). Grafico de puntos de varianza contra promedio?
...
alpha \<- 0.0 \#\#\#\# Medias de las muestras
