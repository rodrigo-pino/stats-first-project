...
# -----------------------------------------------------
values <- c(
    large_sample, large_sample_replace,
...
print_mean <- function(interval, population_mean, alpha) {
    res <- paste(
        ...
        "interval length:",
        format(abs(interval[2] - interval[1]), digits = 3)
    )
    print(res)
}
...
# -----------------------------------------------------
print("Large sample (n = 200) without replacement")
get_variance_conf_interval(large_sample, population_var, alpha)
print("Large sample (n = 200) with replacement")
get_variance_conf_interval(large_sample_replace, population_var, alpha)

print("Big sample (n = 60) without replacement")
get_variance_conf_interval(big_sample, population_var, alpha)
print("Big sample (n = 60) with replacement")
get_variance_conf_interval(big_sample_replace, population_var, alpha)

print("Medium sample (n = 30) without replacement")
get_variance_conf_interval(medium_sample, population_var, alpha)
print("Medium sample (n = 30) with replacement")
get_variance_conf_interval(medium_sample_replace, population_var, alpha)

print("Small sample (n = 20) without replacement")
get_variance_conf_interval(small_sample, population_var, alpha)
print("Small sample (n = 20) with replacement")
get_variance_conf_interval(small_sample_replace, population_var, alpha)
